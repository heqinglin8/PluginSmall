...
public class NetUtil {
	...
	public static boolean CheckNetState() {
		android.net.ConnectivityManager cManager = (android.net.ConnectivityManager) Small.getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
	...
	private static NetworkInfo getNetworkInfo() {
		ConnectivityManager connectMgr = (ConnectivityManager) Small.getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
